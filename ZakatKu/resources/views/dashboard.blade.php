    ...
    <div class="grid max-w-screen-xl px-4 pt-20 pb-12 mx-auto lg:gap-8 xl:gap-0 lg:py-20 lg:grid-cols-12 lg:pt-28">
        <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <div class="flex flex-col sm:flex-row sm:space-x-4 space-y-4 sm:space-y-0">
                <a href="{{ route('transaksi-zakat.index') }}"
...
<section class="bg-gradient-to-br from-green-100 to-yellow-100 dark:bg-gray-900 py-16">
  <div class="max-w-screen-xl mx-auto px-4">
    <h2 class="text-3xl font-bold text-center text-green-800 mb-12">
      Daftar Pembayaran Zakat yang Diterima Tahun Ini
    </h2>

@if($transaksis->count())
<div class="overflow-x-auto rounded-2xl shadow-md bg-white/40 backdrop-blur-sm ring-1 ring-gray-300/30">
  <table class="min-w-full divide-y divide-gray-300 text-sm text-black">
    <thead class="bg-green-600/80 text-yellow-300 uppercase tracking-wide text-xs font-semibold">
      <tr>
        <th class="px-6 py-4 text-left">Nama</th>
        <th class="px-6 py-4 text-left">Jenis Zakat</th>
        <th class="px-6 py-4 text-left">Bentuk Zakat</th>
    ...
    <tbody class="divide-y divide-gray-200">
      ...
      <tr class="hover:bg-white/60 transition duration-150 ease-in-out">
        <td class="px-6 py-4 font-medium">
          {{ strtoupper(substr($trx->atasNama, 0, 1)) . str_repeat('*', max(0, strlen($trx->atasNama) - 1)) }}
        </td>
...
<div class="text-center text-black mt-8">
  Belum ada data pembayaran zakat yang disetujui pada tahun ini.
</div>
@endif
